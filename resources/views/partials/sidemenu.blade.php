<ul class="c-sidebar-nav">
    ...
    @endcan
    <li class="c-sidebar-nav-item">
        <a class="c-sidebar-nav-link {{ request()->is("clients/*") ? "c-active" : "" }}" href="/clients">
            <i class="c-sidebar-nav-icon fas fa-fw fa-address-card"></i>
            Clients
        </a>
    </li>
    <li class="c-sidebar-nav-item">
        <a class="c-sidebar-nav-link {{ request()->is("projects/*") ? "c-active" : "" }}" href="/projects">
            <i class="c-sidebar-nav-icon fas fa-fw fa-copy"></i>
            Projects
        </a>
    </li>
    <li class="c-sidebar-nav-item">
        <a class="c-sidebar-nav-link {{ request()->is("tasks/*") ? "c-active" : "" }}" href="/tasks">
